...
from state import EnrichedDeal, Deal, SimilarCompany
...
class PDFReportBuilder:
    ...
    def _build_deal_section(self, enriched_deal: EnrichedDeal, deal_number: int) -> List:
        ...
        if deal.tags:
            tags_str = ", ".join([t for t in deal.tags if t])
            if tags_str:
                deal_data.append(["Tags", tags_str])
    ...
    def _build_footer_page(self) -> List:
        ...
        <br/><br/>
        <b>Data Sources:</b><br/>
        • Internal CSV database for original deals<br/>
